...
export const RockinGoose = styled.div`
    ...
    @keyframes Animation {
        ...
        30% {
            transform: scale(0.85) rotate(8deg) perspective(15px) translate(10px, -10px);
        }
        40% {
            transform: scale(0.8) rotate(4deg) perspective(20px) translate(0px, -20px);
        }
        50% {
            transform: scale(0.75) rotate(0deg) perspective(25px) translate(-10px, -15px);
        }
        60% {
            transform: scale(0.8) rotate(-5deg) perspective(20px) translate(-20px, -10px);
        }
        70% {
            transform: scale(0.85) rotate(-13deg) perspective(15px) translate(-15px, -5px);
        }
        80% {
            transform: scale(0.9) rotate(-8deg) perspective(10px) translate(-10px, 0px);
        }
        90% {
            transform: scale(0.95) rotate(-4deg) perspective(5px) translate(-5px, 10px);
        }
        100% {
